...
public class Menghitungtotalnilai {
    ...
    public static void main(String[] args) {
        Scanner objekhitung = new Scanner(System.in);
        double totalnilai;
        
        //membuat objek dari class Hitungnilai
        Hitungnilai objekhitung = new Hitungnilai();
        totalnilai = objekhitung.hitungtubes(80)+
        objekhitung.hitungtugas(80)+objekhitung.hitungquiz
        (90)+objekhitung.hitungUTS(90)+objekhitung.hitungUAS(75);

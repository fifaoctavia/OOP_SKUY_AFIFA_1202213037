...
public class Latihan {
    public static void main(String[] args) {
                ...
                do {
                    ...
                    for (Kout = 0; Kout <= 5; Kout++) {
                        if (Kout == 5) { // Jika Loop ke 6, maka dipastikan GameOver
                            System.out.println("GAMEOVER! Anda Gagal jawaban :" + " " + AngKaAcak);
                            ...
                            if (AkuTeb == AngKaAcak) { // JIka inputan dan random sama
                                ...
                                System.out.println("Selamat Anda berhasil menebak Angka dalam " + NeTebak
                                        + " kali tebakan. Sekor anda adalah " + NilaiPasJalan);
                                break;

                            } else { // Gagal menebak, akan dimumculkan informasi dan sisa tebakan yang bisa
                                     // dilakukan
                                if (AkuTeb > AngKaAcak) {
                                    System.out.println("Tebakan Anda terlalu Besar! Anda mempunyai kesempatan " + Kurang
                                            + " kali lagi"); // Jika Tebakan lebih besar dari angka random
                                } else {

                                    System.out.println("Tebakan Anda terlalu Kecil! Anda mempunyai kesempatan " + Kurang
                                            + " kali lagi"); // Jika tebakan lebih kecil dari angka random
                                }
                            }
                        }
                    }
                    ...
                    if (PilihLevel == 5) { // Jika sudah Mencapai Level 5, langsung di break/otomatis Exit
                        ...
                        System.out.println(
                                "Ketik 'next' dan tekan enter untuk lanjut ke Level berikutnya atau ketik 'exit' untuk keluar : ");
        ...
        int jumPemain = namauser.size(); // Mengambil jumlah Rercord dalam array, dan untuk menghilangkan y paling
                                         // belakang pada loop dikurangi 1 (-1)
